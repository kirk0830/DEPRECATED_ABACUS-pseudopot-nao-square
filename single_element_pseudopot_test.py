...
import abacus_pseudopotential_square.base.abacus as ab
import abacus_pseudopotential_square.configure.materials_project as mp
import abacus_pseudopotential_square.generation.batch_set as bs
...
def prepare_template_input(api_key: str, elements: list, softare = "ABACUS", move = False, **kwargs) -> None:
    ...
    for element in elements:
        ...
        cif_filenames = mp.single_element_structures(api_key, element, num_cif = 1)
